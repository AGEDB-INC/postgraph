...
CREATE FUNCTION ag_catalog.age_age(agtype)
RETURNS agtype
LANGUAGE c
STABLE
RETURNS NULL ON NULL INPUT
PARALLEL SAFE
AS 'MODULE_PATHNAME', 'age_age_today';
...
CREATE FUNCTION age_isfinite(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_justify_interval(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_justify_days(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION age_justify_hours(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION ag_catalog.agtype_typecast_timestamp(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE 
...
CREATE FUNCTION ag_catalog.agtype_typecast_date(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION ag_catalog.agtype_typecast_time(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
...
CREATE FUNCTION ag_catalog.agtype_typecast_timetz(agtype)
RETURNS agtype
LANGUAGE c
IMMUTABLE
PARALLEL SAFE
