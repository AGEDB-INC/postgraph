...
INSERT INTO agtype_table VALUES ('time', '"07:37:16-08"::time');
...
SELECT agtype_add('"2000-1-1 12:00:00"::timestamp', '"30 Seconds"::interval');
SELECT agtype_add('"2000-1-1 12:00:00"::timestamp', '"45 Minutes"::interval');
SELECT agtype_add('"2000-1-1 12:00:00"::timestamp', '"12 Hours"::interval');
SELECT agtype_add('"2000-1-1 12:00:00"::timestamp', '"5 Days"::interval');
SELECT agtype_add('"2000-1-1 12:00:00"::timestamp', '"2 Weeks"::interval');
SELECT agtype_add('"2000-1-1 12:00:00"::timestamp', '"13 Months"::interval');
SELECT agtype_add('"2000-1-1 12:00:00"::timestamp', '"10 Years"::interval');
SELECT agtype_add('"2000-1-1 12:00:00"::timestamp', '"30 Seconds Ago"::interval');
SELECT agtype_add('"2000-1-1 12:00:00"::timestamp', '"45 Minutes Ago"::interval');
SELECT agtype_add('"2000-1-1 12:00:00"::timestamp', '"12 Hours Ago"::interval');
SELECT agtype_add('"2000-1-1 12:00:00"::timestamp', '"5 Days Ago"::interval');
...
SELECT agtype_add('"2000-1-1"::date', '1');
SELECT agtype_add('"2000-1-1"::date', '-1');
SELECT agtype_add('"2000-1-1"::date', '"30 Seconds"::interval');
SELECT agtype_add('"2000-1-1"::date', '"45 Minutes"::interval');
SELECT agtype_add('"2000-1-1"::date', '"12 Hours"::interval');
SELECT agtype_add('"2000-1-1"::date', '"5 Days"::interval');
SELECT agtype_add('"2000-1-1"::date', '"2 Weeks"::interval');
SELECT agtype_add('"2000-1-1"::date', '"13 Months"::interval');
SELECT agtype_add('"2000-1-1"::date', '"10 Years"::interval');
SELECT agtype_add('"2000-1-1"::date', '"30 Seconds Ago"::interval');
SELECT agtype_add('"2000-1-1"::date', '"45 Minutes Ago"::interval');
SELECT agtype_add('"2000-1-1"::date', '"12 Hours Ago"::interval');
SELECT agtype_add('"2000-1-1"::date', '"5 Days Ago"::interval');
SELECT agtype_add('"2000-1-1"::date', '"2 Weeks Ago"::interval');
SELECT agtype_add('"2000-1-1"::date', '"13 Months Ago"::interval');
SELECT agtype_add('"2000-1-1"::date', '"10 Years Ago"::interval');
SELECT agtype_add('"2000-1-1"::date', '"10 Years Ago"::interval');
SELECT agtype_add('"2000-1-1"::date', '"07:37:16-08"::time');
SELECT agtype_add('"2000-1-1"::date', '"07:37:16"::time');
SELECT agtype_add('"07:30:00"::time', '"10 Seconds Ago"::interval');
SELECT agtype_add('"07:30:00"::time', '"45 Minutes Ago"::interval');
SELECT agtype_add('"07:30:00"::time', '"5 Days"::interval');
SELECT agtype_add('"07:30:00"::time', '"30 Seconds"::interval');
SELECT agtype_add('"07:30:00"::time', '"12 Hours Ago"::interval');
SELECT agtype_add('"07:30:00"::time', '"12 Hours"::interval');
...
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"2000-1-1 00:00:00"::timestamp');
SELECT agtype_sub('"2100-1-1 12:00:00"::timestamp', '"2000-1-1 12:00:00"::timestamp');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"2000-2-1 12:00:00"::timestamp');
SELECT agtype_sub('"2000-1-10 12:00:00"::timestamp', '"2000-1-1 12:00:00"::timestamp');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"2000-1-30 12:00:00"::timestamp');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"2000-1-1 12:59:00"::timestamp');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"2000-1-1 12:00:30"::timestamp');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"30 Seconds"::interval');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"45 Minutes"::interval');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"12 Hours"::interval');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"5 Days"::interval');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"2 Weeks"::interval');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"13 Months"::interval');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"10 Years"::interval');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"30 Seconds Ago"::interval');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"45 Minutes Ago"::interval');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"12 Hours Ago"::interval');
SELECT agtype_sub('"2000-1-1 12:00:00"::timestamp', '"5 Days Ago"::interval');
...
SELECT agtype_sub('"2000-1-1"::date', '"2000-1-1"::date');
SELECT agtype_sub('"2000-1-1"::date', '"2001-1-1"::date');
SELECT agtype_sub('"2000-1-1"::date', '"1999-1-1"::date');
SELECT agtype_sub('"2000-1-1"::date', '"30 Seconds"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"45 Minutes"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"12 Hours"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"5 Days"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"2 Weeks"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"13 Months"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"10 Years"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"30 Seconds Ago"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"45 Minutes Ago"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"12 Hours Ago"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"5 Days Ago"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"2 Weeks Ago"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"13 Months Ago"::interval');
SELECT agtype_sub('"2000-1-1"::date', '"10 Years Ago"::interval');
SELECT agtype_sub('"2000-1-1"::date', '1');
SELECT agtype_sub('"2000-1-1"::date', '-1');
SELECT agtype_sub('"07:30:00"::time', '"07:30:00"::time');
SELECT agtype_sub('"07:30:00"::time', '"08:30:00"::time');
SELECT agtype_sub('"07:30:00"::time', '"06:30:00"::time');
SELECT agtype_sub('"07:30:00"::time', '"10 Seconds Ago"::interval');
SELECT agtype_sub('"07:30:00"::time', '"45 Minutes Ago"::interval');
SELECT agtype_sub('"07:30:00"::time', '"5 Days"::interval');
SELECT agtype_sub('"07:30:00"::time', '"30 Seconds"::interval');
SELECT agtype_sub('"07:30:00"::time', '"12 Hours Ago"::interval');
SELECT agtype_sub('"07:30:00"::time', '"12 Hours"::interval');
...
SELECT agtype_mul('"1 Year"::interval', '5');
SELECT agtype_mul('"20 Seconds"::interval', '10');
SELECT agtype_mul('"10 Minutes"::interval', '3');
SELECT agtype_mul('"59 Minutes"::interval', '6');
SELECT agtype_mul('"1 Year"::interval', '0.5');
SELECT agtype_mul('"20 Seconds"::interval', '10.0');
SELECT agtype_mul('"10 Minutes"::interval', '1.0');
SELECT agtype_mul('"59 Minutes"::interval', '-5.9');
SELECT agtype_mul('"1 Year"::interval', '0.5::numeric');
SELECT agtype_mul('"20 Seconds"::interval', '10.0::numeric');
SELECT agtype_mul('"10 Minutes"::interval', '1.0::numeric');
SELECT agtype_mul('"59 Minutes"::interval', '-5.9::numeric');
