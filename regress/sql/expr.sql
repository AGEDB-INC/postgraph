...
$$) AS (age agtype);
SELECT * FROM cypher('expr', $$
    RETURN age('2100-1-1'::timestamp)
$$) AS (age agtype);
SELECT * FROM cypher('expr', $$
    RETURN age('2100-1-1 00:00:00'::timestamp)
$$) AS (age agtype);
SELECT * FROM cypher('expr', $$
    RETURN age('2100-1-1 12:00:00'::timestamp)
$$) AS (age agtype);
...
SELECT * from cypher('time', $$RETURN date_part('Year','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Month','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Day','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Hour','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Minutes','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Second','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Timezone','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Timezone_hour','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN date_part('Timezone_minute','20:38:40-06:40'::timetz)$$) as (range agtype);
...
SELECT * from cypher('time', $$RETURN extract('Year','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN extract('Month','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN extract('Day','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN extract('Hour','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN extract('Minutes','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN extract('Second','20:38:40-06:40'::timetz)$$) as (range agtype);
SELECT * from cypher('time', $$RETURN extract('Timezone','20:38:40-06:40'::timetz)$$) as (range agtype);
